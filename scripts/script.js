...
const ricardoShow = document.getElementById('music-container')
...
ricardoBtn.addEventListener('click', ()=>ricardoShow.classList.add('ricardo-show'));
ricardoHideBtn.addEventListener('click', ()=>ricardoShow.classList.remove('ricardo-show'));
